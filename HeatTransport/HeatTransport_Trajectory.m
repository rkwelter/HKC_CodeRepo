...
%HEATTRANSPORT_TRAJECTORY by Roland Welter 
%computes the heat transport for a single trajectory and plots the
%cumulative heat transport as a function of time. 
