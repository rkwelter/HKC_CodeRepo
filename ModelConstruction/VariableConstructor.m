function [uPlusModes,uMinusModes,thetaModes] = VariableConstructor(M)
%VARIABLECONSTRUCTOR builds a vector containing all of the modes for each
%variable u^+,u^-, and theta given a model number M
